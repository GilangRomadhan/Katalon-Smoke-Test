...
Mobile.tap(findTestObject('Registrasi/reg.checkbox-Dont show me again'), 1)
...
Mobile.setText(findTestObject('General/general.btn - Describe your photo'), 'Post Stories Live Photo by GR', 5)
