...
Mobile.tap(findTestObject('Group/group.btn - DELETE GROUP'), 1)

Mobile.tap(findTestObject('Group/group.btn - DELETE'), 1)

Mobile.verifyElementNotVisible(findTestObject('Front View/frontView.text - Create Group by GR'), 60)
